...
public class BookController {
    ...
    @Autowired//@Autowired - создание связи
    ...
    public String saveBook(@ModelAttribute BookInLibrary bookInLibrary) {
        Book book = new Book(bookInLibrary.getTitle(), bookInLibrary.getPages());
        book.setLibrary(libraryRepository.getById(bookInLibrary.getLibrary_id()));
